...
document.querySelectorAll('.update-quantity-link').forEach((link)=>{
  link.addEventListener('click',()=>{
    ...
    const conta=document.querySelector(`.js-cart-item-container-${productId}`);
  
    conta.classList.add('is-editing-quantity');
  });
});
...
document.querySelectorAll('.js-save-link').forEach((link)=>{
  link.addEventListener('click',()=>{
    ...
    const quantityInput = document.querySelector(
      `.js-quantity-input[data-product-id="${prodId}"]`
    );

    const newQuant = Number(quantityInput.value);
    ...
    updateQuantity(prodId,newQuant);

    const contai = document.querySelector(
      `.js-cart-item-container-${prodId}`
    );

    contai.classList.remove('is-editing-quantity');

    const quantityLabel = contai.querySelector('.quantity-label');

    quantityLabel.innerHTML = newQuant;
    
    const quantLabel=document.querySelector('.js-quantity-label');
    quantLabel.innerHTML=newQuant;
